//
//  SetNewLoginPswViewController.m
//  app
//
...
@interface SetNewLoginPswViewController ()
...
@implementation SetNewLoginPswViewController
...
- (void)textFieldChange:(UITextField *)textField
{
    ...
    if (self.passwordFieldView.textField.text.length > 16 || self.confirmPasswordFieldView.textField.text.length > 16) {
...
- (void)ClickNextButton {
    ...
    SuccessSetLoginPsdViewController *successVc = [[SuccessSetLoginPsdViewController alloc] init];
